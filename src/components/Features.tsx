  ...
  return (
    <div className="container-max">
            ...
            <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
              <div className="space-content">
                <div className="flex items-center gap-3 mb-4">
                  <div className="bg-primary-800 text-white p-2 rounded-lg">
                    {feature.icon}
                  </div>
                  <span className="text-sm font-medium text-primary-800 bg-primary-50 px-3 py-1 rounded-full">
                    Feature {index + 1}
                  </span>
                </div>
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="text-center mt-20 p-8 bg-gray-50 rounded-2xl"
      >
